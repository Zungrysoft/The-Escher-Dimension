...
execute if predicate tid:random_10 run data modify entity @s HandItems[0] set value {id:"minecraft:iron_sword",Count:1,tag:{Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}}
execute if predicate tid:random_05 run data modify entity @s HandItems[0] set value {id:"minecraft:iron_axe",Count:1,tag:{Enchantments:[{id:"minecraft:fire_aspect",lvl:1}]}}
