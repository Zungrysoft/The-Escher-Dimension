...
#Large Room
execute unless score @s failed matches 1.. if predicate tid:random_08 positioned ~-17 ~-11 ~-21 if blocks ~ ~128 ~ ~28 ~148 ~21 1001 1 1001 all run function tid:dungeon/brick/select_largeroom
execute unless score @s failed matches 1.. if predicate tid:random_08 positioned ~-10 ~-11 ~-21 if blocks ~ ~128 ~ ~28 ~148 ~21 1001 1 1001 all run function tid:dungeon/brick/select_largeroom
