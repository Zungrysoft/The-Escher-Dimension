...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:brick/tee_north_2", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
