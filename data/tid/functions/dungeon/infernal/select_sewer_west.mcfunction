...
execute at @s positioned ~-5 ~-1 ~-2 run fill ~ ~128 ~ ~4 ~131 ~4 minecraft:blue_wool

#Summon the first sewer section
execute at @s run summon minecraft:area_effect_cloud ~-5 ~-1 ~-2 {Duration:99999999,CustomName:"\"new_spawn\""}
