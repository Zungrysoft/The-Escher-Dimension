...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:infernal/glassbridge/stairs_north", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
