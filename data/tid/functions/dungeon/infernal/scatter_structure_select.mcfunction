...
execute unless blocks ~-5 ~125 ~-5 ~20 ~148 ~20 1001 1 1001 all run scoreboard players set temp value -1

#For the first few structures, also build an explosive drill directly above it
execute if score temp value matches 0.. if score power_drills value matches 1.. positioned ~-10 111 ~-10 if blocks ~ ~128 ~ ~26 ~143 ~26 1001 1 1001 all run function tid:dungeon/infernal/select_power_drill
