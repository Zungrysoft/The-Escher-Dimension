...
execute if score success value matches 1 positioned ~-3 ~-1 ~-6 if blocks ~ ~128 ~ ~6 ~136 ~6 1001 1 1001 all run function tid:dungeon/infernal/tower/select_short_stairs_short
