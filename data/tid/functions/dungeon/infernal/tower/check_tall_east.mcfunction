...
execute unless score @s failed matches 1.. if predicate tid:random_10 unless entity @e[type=area_effect_cloud,name="tower_marker",distance=0..15] positioned ~0 ~-1 ~-3 if blocks ~ ~128 ~ ~6 ~136 ~6 1001 1 1001 all run function tid:dungeon/infernal/tower/select_short_stairs
