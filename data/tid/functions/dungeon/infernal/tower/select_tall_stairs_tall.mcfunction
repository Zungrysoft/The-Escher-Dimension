...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:infernal/tower/tall_stairs_tall_1", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
execute if predicate tid:random_10 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:infernal/tower/tall_stairs_tall_2", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
execute if predicate tid:random_33 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:infernal/tower/tall_stairs_tall_3", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}

#Activate whichever structure block was picked
setblock ~ ~1 ~ minecraft:redstone_block

#Mark this area as generated
fill ~1 ~128 ~1 ~5 ~143 ~5 minecraft:blue_wool
...
execute run summon minecraft:area_effect_cloud ~3 ~10 ~ {Duration:99999999,CustomName:"\"infernal_tower_tall_north\""}
execute run summon minecraft:area_effect_cloud ~3 ~10 ~6 {Duration:99999999,CustomName:"\"infernal_tower_tall_south\""}
execute run summon minecraft:area_effect_cloud ~ ~10 ~3 {Duration:99999999,CustomName:"\"infernal_tower_tall_west\""}
execute run summon minecraft:area_effect_cloud ~6 ~10 ~3 {Duration:99999999,CustomName:"\"infernal_tower_tall_east\""}
