...
execute if score tanktower_mode value matches 4 run function tid:dungeon/infernal/tanktower_top
...
#Build another piece
execute if score tanktower_mode value matches 0..4 positioned ~ ~7 ~ if blocks ~ ~128 ~ ~6 ~134 ~6 1001 1 1001 all run function tid:dungeon/infernal/tanktower_segment
