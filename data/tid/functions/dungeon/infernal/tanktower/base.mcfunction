...
#Add next piece
execute if score temp value matches 0 positioned ~7 ~ ~ if blocks ~ ~128 ~ ~6 ~134 ~6 1001 1 1001 all run function tid:dungeon/infernal/tanktower/base
execute if score temp value matches 1 positioned ~ ~ ~7 if blocks ~ ~128 ~ ~6 ~134 ~6 1001 1 1001 all run function tid:dungeon/infernal/tanktower/base
execute if score temp value matches 2 positioned ~-7 ~ ~ if blocks ~ ~128 ~ ~6 ~134 ~6 1001 1 1001 all run function tid:dungeon/infernal/tanktower/base
execute if score temp value matches 3 positioned ~ ~ ~-7 if blocks ~ ~128 ~ ~6 ~134 ~6 1001 1 1001 all run function tid:dungeon/infernal/tanktower/base

#Build Tower
fill ~-1 ~-15 ~-1 ~7 ~-1 ~7 polished_andesite
execute positioned ~ ~128 ~ run fill ~-1 ~-15 ~-1 ~7 ~-1 ~7 blue_wool
...
function tid:dungeon/infernal/tanktower/segment
