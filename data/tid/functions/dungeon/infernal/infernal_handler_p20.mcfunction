...
execute unless entity @e[type=area_effect_cloud,name="infernal_north"] unless entity @e[type=area_effect_cloud,name="infernal_south"] unless entity @e[type=area_effect_cloud,name="infernal_east"] unless entity @e[type=area_effect_cloud,name="infernal_west"] unless entity @e[type=area_effect_cloud,name="infernal_up"] unless entity @e[type=area_effect_cloud,name="infernal_down"] unless entity @e[type=area_effect_cloud,name="sewer_section"] run scoreboard players set infernal_handler_phase value 30