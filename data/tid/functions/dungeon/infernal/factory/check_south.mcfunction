...
execute if score @s failed matches 1.. if block ~2 ~1 ~ stone_brick_stairs if block ~-2 ~1 ~ stone_brick_stairs positioned ~-2 ~-1 ~1 if blocks ~ ~128 ~ ~4 ~130 ~3 1001 1 1001 all run function tid:dungeon/infernal/factory/select_pad_south
