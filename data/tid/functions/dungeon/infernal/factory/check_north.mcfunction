...
execute if score @s failed matches 1.. positioned ~0 ~-1 ~-5 if blocks ~ ~128 ~ ~0 ~134 ~4 1001 1 1033 all run function tid:dungeon/infernal/factory/select_spacer_west