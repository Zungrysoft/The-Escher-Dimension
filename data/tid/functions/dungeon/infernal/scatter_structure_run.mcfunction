execute if predicate tid:random_50 at @s run tp @s ~128 ~ ~
execute if predicate tid:random_50 at @s run tp @s ~64 ~ ~
...
execute at @s run function tid:dungeon/infernal/scatter_structure_select
