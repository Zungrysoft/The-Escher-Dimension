...
summon minecraft:area_effect_cloud ~4 ~1 ~2 {Duration:99999999,CustomName:"\"infernal_east\""}

#If no features generate here, generate an outflow pipe for decoration
summon minecraft:area_effect_cloud ~4 ~1 ~2 {Duration:99999999,CustomName:"\"sewer_outflow_east\""}
