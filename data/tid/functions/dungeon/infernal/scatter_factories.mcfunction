...
execute at @e[type=area_effect_cloud,name="factory_marker",limit=1,sort=random] positioned ~-13 111 ~-13 if blocks ~ ~128 ~ ~26 ~143 ~26 1001 1 1001 all run function tid:dungeon/infernal/select_power_drill
