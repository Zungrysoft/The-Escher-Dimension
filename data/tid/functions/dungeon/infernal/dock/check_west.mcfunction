...
execute if score @s failed matches 1.. if predicate tid:random_90 positioned ~-8 ~-3 ~-2 if blocks ~ ~128 ~ ~10 ~138 ~5 1001 1 1001 all run function tid:dungeon/infernal/dock/select_chest_west
