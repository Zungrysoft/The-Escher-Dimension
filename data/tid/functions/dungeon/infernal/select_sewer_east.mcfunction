...
setblock ~1 ~-9 ~-12 minecraft:structure_block{name: "tid:infernal/sewer/base", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}

#Activate whichever structure block was picked
setblock ~1 ~-8 ~-12 minecraft:redstone_block

#Mark this area as generated
fill ~1 ~119 ~-12 ~30 ~142 ~17 minecraft:yellow_wool

#Summon the first sewer section
summon minecraft:area_effect_cloud ~1 ~-1 ~-2 {Duration:99999999,CustomName:"\"new_spawn\""}
