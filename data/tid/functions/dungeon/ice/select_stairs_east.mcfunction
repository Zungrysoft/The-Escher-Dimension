...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:ice/stairs_east", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
...
#Summon doorways
summon minecraft:area_effect_cloud ~ ~1 ~1 {Duration:99999999,CustomName:"\"ice_west\""}
summon minecraft:area_effect_cloud ~5 ~4 ~1 {Duration:99999999,CustomName:"\"ice_east\""}
