...
execute unless score @s failed matches 1.. if predicate tid:random_07 positioned ~-1 ~-2 ~1 if blocks ~ ~128 ~ ~3 ~131 ~8 1001 1 1001 all run function tid:dungeon/ice/select_bridge_north
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~-1 ~-1 ~1 if blocks ~ ~128 ~ ~3 ~133 ~5 1001 1 1001 all run function tid:dungeon/ice/select_stairs_south
execute unless score @s failed matches 1.. if predicate tid:random_02 positioned ~-1 ~-4 ~1 if blocks ~ ~128 ~ ~3 ~133 ~5 1001 1 1001 all run function tid:dungeon/ice/select_stairs_north
