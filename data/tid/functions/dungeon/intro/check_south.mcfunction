...
#Diorite (Final room)
execute unless score @s failed matches 1.. if score intro_rooms value matches ..20 positioned ~-6 ~-2 ~1 if blocks ~ ~-128 ~ ~12 ~-121 ~12 1001 129 1001 all run function tid:dungeon/intro/select_diorite
