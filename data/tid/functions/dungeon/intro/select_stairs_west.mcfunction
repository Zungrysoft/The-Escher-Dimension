...
setblock ~2 ~ ~2 minecraft:structure_block{name: "tid:intro/stairs_west", posX: -2, posY: 0, posZ: -2, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
