...
setblock ~2 ~ ~2 minecraft:structure_block{name: "tid:intro/stairs_south", posX: -2, posY: 0, posZ: -2, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
...
#Summon doorways
summon minecraft:area_effect_cloud ~2 ~2 ~ {Duration:99999999,CustomName:"\"intro_north\"",Tags:["stairs"]}
