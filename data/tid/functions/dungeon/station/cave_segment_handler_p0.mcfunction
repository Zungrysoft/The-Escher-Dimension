#North
execute if predicate tid:random_50 positioned ~ ~ ~-32 if blocks ~ ~128 ~ ~31 ~154 ~31 1001 1 1001 all run function tid:dungeon/station/cave_expand
...
#Up
execute if predicate tid:random_70 positioned ~ ~27 ~ if blocks ~ ~128 ~ ~31 ~154 ~31 1001 1 1001 all run function tid:dungeon/station/cave_expand
...
scoreboard players remove layer_4_handler_counter value 1
