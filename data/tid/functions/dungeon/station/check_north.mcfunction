...
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~-2 ~-1 ~-11 if blocks ~ ~128 ~ ~14 ~136 ~10 1033 1 1033 all run function tid:dungeon/station/select_stack_north
