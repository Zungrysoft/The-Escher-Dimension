...
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~1 ~-3 ~-6 if blocks ~ ~128 ~ ~12 ~136 ~12 1033 1 1033 all run function tid:dungeon/station/select_platform
