...
execute as @e[type=minecraft:area_effect_cloud,name="mutant_north"] at @s run function tid:dungeon/mutant/check_north
execute as @e[type=minecraft:area_effect_cloud,name="mutant_east"] at @s run function tid:dungeon/mutant/check_east
execute as @e[type=minecraft:area_effect_cloud,name="mutant_south"] at @s run function tid:dungeon/mutant/check_south
execute as @e[type=minecraft:area_effect_cloud,name="mutant_west"] at @s run function tid:dungeon/mutant/check_west
execute as @e[type=minecraft:area_effect_cloud,name="mutant_up"] at @s run function tid:dungeon/mutant/check_up

#Once all of the rooms are done generating, move to the next phase
execute unless entity @e[type=area_effect_cloud,name="station_north"] unless entity @e[type=area_effect_cloud,name="station_south"] unless entity @e[type=area_effect_cloud,name="station_east"] unless entity @e[type=area_effect_cloud,name="station_west"] unless entity @e[type=area_effect_cloud,name="station_up"] unless entity @e[type=area_effect_cloud,name="station_down"] unless entity @e[type=area_effect_cloud,name="moon_north"] unless entity @e[type=area_effect_cloud,name="moon_south"] unless entity @e[type=area_effect_cloud,name="moon_east"] unless entity @e[type=area_effect_cloud,name="moon_west"] unless entity @e[type=area_effect_cloud,name="moon_bridge_north"] unless entity @e[type=area_effect_cloud,name="moon_bridge_south"] unless entity @e[type=area_effect_cloud,name="moon_bridge_east"] unless entity @e[type=area_effect_cloud,name="moon_bridge_west"] unless entity @e[type=area_effect_cloud,name="moon_bridge_up"] unless entity @e[type=area_effect_cloud,name="mutant_north"] unless entity @e[type=area_effect_cloud,name="mutant_south"] unless entity @e[type=area_effect_cloud,name="mutant_east"] unless entity @e[type=area_effect_cloud,name="mutant_west"] unless entity @e[type=area_effect_cloud,name="mutant_up"] run scoreboard players set layer_3_handler_phase value 30
