...
execute unless score @s failed matches 1.. if predicate tid:random_20 positioned ~-17 ~-2 ~-2 if blocks ~ ~128 ~ ~16 ~132 ~4 1001 1 1001 all run function tid:dungeon/mutant/select_bridge_west
