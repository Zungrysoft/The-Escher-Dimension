...
execute unless score @s failed matches 1.. if score mutant_arenas value matches ..1 if score mutant_rooms value matches ..50 positioned ~-9 ~-3 ~-19 if blocks ~ ~128 ~ ~18 ~138 ~18 1001 1 1001 all run function tid:dungeon/mutant/select_arena
