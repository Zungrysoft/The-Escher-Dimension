...
execute unless score @s failed matches 1.. if predicate tid:random_07 positioned ~-6 ~1 ~-6 if blocks ~ ~128 ~ ~12 ~145 ~12 1001 1 1001 all run function tid:dungeon/mutant/select_medium
