...
execute unless score @s failed matches 1.. if predicate tid:random_10 positioned ~1 ~-2 ~-2 if blocks ~ ~128 ~ ~16 ~132 ~4 1001 1 1001 all run function tid:dungeon/mutant/select_bridge_west
execute unless score @s failed matches 1.. if predicate tid:random_02 positioned ~1 ~-3 ~-9 if blocks ~ ~128 ~ ~18 ~138 ~18 1001 1 1001 all run function tid:dungeon/mutant/select_arena
...
execute if score @s failed matches 1.. if predicate tid:random_50 positioned ~1 ~-2 ~-2 if blocks ~ ~128 ~ ~3 ~134 ~4 1001 1 1001 all run function tid:dungeon/mutant/select_closet_east
