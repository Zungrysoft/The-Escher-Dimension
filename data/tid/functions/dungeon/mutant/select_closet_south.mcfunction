...
setblock ~1 ~ ~1 minecraft:structure_block{name: "tid:mutant/closet_south", posX: -1, posY: 0, posZ: -1, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
...
fill ~2 255 ~ ~2 255 ~1 minecraft:light_blue_concrete replace minecraft:cyan_concrete
fill ~1 255 ~2 ~3 255 ~2 minecraft:light_blue_concrete replace minecraft:cyan_concrete
