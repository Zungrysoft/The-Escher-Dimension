...
execute unless entity @e[type=area_effect_cloud,name="stronghold2_north"] unless entity @e[type=area_effect_cloud,name="stronghold2_south"] unless entity @e[type=area_effect_cloud,name="stronghold2_east"] unless entity @e[type=area_effect_cloud,name="stronghold2_west"] unless entity @e[type=area_effect_cloud,name="stronghold2_up"] unless entity @e[type=area_effect_cloud,name="brick_north"] unless entity @e[type=area_effect_cloud,name="brick_south"] unless entity @e[type=area_effect_cloud,name="brick_east"] unless entity @e[type=area_effect_cloud,name="brick_west"] run scoreboard players set layer_1_handler_phase value 3