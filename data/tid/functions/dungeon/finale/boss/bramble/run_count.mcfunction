...
execute if score temp value matches 0.. run function tid:dungeon/finale/boss/bramble/run_count
...
#Decide which type of block to build
...
scoreboard players set movesleft value 20
execute at @e[type=area_effect_cloud,tag=new,limit=1] run function tid:dungeon/finale/boss/bramble/generate
