...
summon minecraft:area_effect_cloud ~16 ~2 ~3 {Duration:99999999,CustomName:"\"soulsand_east\""}
summon minecraft:area_effect_cloud ~ ~2 ~3 {Duration:99999999,CustomName:"\"soulsand_west\""}
