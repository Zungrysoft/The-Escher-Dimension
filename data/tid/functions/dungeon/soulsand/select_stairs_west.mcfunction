...
summon minecraft:area_effect_cloud ~9 ~1 ~3 {Duration:99999999,CustomName:"\"soulsand_east\"",Tags:["straight"]}
summon minecraft:area_effect_cloud ~ ~6 ~3 {Duration:99999999,CustomName:"\"soulsand_west\"",Tags:["straight"]}
