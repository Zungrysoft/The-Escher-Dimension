...
execute unless score @s failed matches 1.. if predicate tid:random_10 positioned ~1 ~-2 ~-3 if blocks ~ ~128 ~ ~16 ~134 ~6 1001 1 1001 all run function tid:dungeon/soulsand/select_hall_west
