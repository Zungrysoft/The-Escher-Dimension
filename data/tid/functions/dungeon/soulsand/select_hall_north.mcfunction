...
summon minecraft:area_effect_cloud ~3 ~2 ~16 {Duration:99999999,CustomName:"\"soulsand_south\""}
summon minecraft:area_effect_cloud ~3 ~2 ~ {Duration:99999999,CustomName:"\"soulsand_north\""}
