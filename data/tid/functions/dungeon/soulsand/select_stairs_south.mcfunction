...
summon minecraft:area_effect_cloud ~3 ~6 ~9 {Duration:99999999,CustomName:"\"soulsand_south\"",Tags:["straight"]}
summon minecraft:area_effect_cloud ~3 ~1 ~ {Duration:99999999,CustomName:"\"soulsand_north\"",Tags:["straight"]}
