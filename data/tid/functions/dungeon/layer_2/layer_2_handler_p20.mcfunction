...
execute unless entity @e[type=area_effect_cloud,name="neon_north"] unless entity @e[type=area_effect_cloud,name="neon_south"] unless entity @e[type=area_effect_cloud,name="neon_east"] unless entity @e[type=area_effect_cloud,name="neon_west"] unless entity @e[type=area_effect_cloud,name="neon_lava_north"] unless entity @e[type=area_effect_cloud,name="neon_lava_south"] unless entity @e[type=area_effect_cloud,name="neon_lava_east"] unless entity @e[type=area_effect_cloud,name="neon_lava_west"] unless entity @e[type=area_effect_cloud,name="neon_zone_north"] unless entity @e[type=area_effect_cloud,name="neon_zone_south"] unless entity @e[type=area_effect_cloud,name="neon_zone_east"] unless entity @e[type=area_effect_cloud,name="neon_zone_west"] unless entity @e[type=area_effect_cloud,name="sand1_north"] unless entity @e[type=area_effect_cloud,name="sand1_south"] unless entity @e[type=area_effect_cloud,name="sand1_east"] unless entity @e[type=area_effect_cloud,name="sand1_west"] unless entity @e[type=area_effect_cloud,name="sand2_north"] unless entity @e[type=area_effect_cloud,name="sand2_south"] unless entity @e[type=area_effect_cloud,name="sand2_east"] unless entity @e[type=area_effect_cloud,name="sand2_west"] run scoreboard players set layer_2_handler_phase value 30
