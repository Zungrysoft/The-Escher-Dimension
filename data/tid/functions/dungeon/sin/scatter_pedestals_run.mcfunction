...
#Generate
execute at @s[type=area_effect_cloud,name="scatter"] if block ~ ~-1 ~ basalt positioned ~-5 ~ ~-5 if blocks ~ ~-128 ~ ~8 ~-116 ~8 1001 1 1001 all run function tid:dungeon/sin/select_pedestal
