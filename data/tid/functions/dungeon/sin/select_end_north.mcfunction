...
setblock ~1 ~ ~1 minecraft:structure_block{name: "tid:sin/end_north", posX: -1, posY: 0, posZ: -1, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
