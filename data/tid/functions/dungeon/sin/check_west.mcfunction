...
#Black
execute unless score @s failed matches 1.. if predicate tid:random_04 if score @s counter1 matches 15 positioned ~-9 ~-7 ~-5 if blocks ~ ~-128 ~ ~8 ~-115 ~17 1001 1 1001 all run function tid:dungeon/sin/select_slant
