...
execute unless score @s failed matches 1.. if predicate tid:random_04 positioned ~-7 ~-7 ~-3 if blocks ~ ~-128 ~ ~30 ~-118 ~30 1033 1 1033 all run function tid:dungeon/sin/chambers/select_open

#Tier Room
execute unless score @s failed matches 1.. if predicate tid:random_02 positioned ~-13 ~-2 ~-7 if blocks ~4 ~-128 ~4 ~10 ~-121 ~10 1033 1 1033 all if blocks ~2 ~-120 ~2 ~12 ~-113 ~12 1033 1 1033 all if blocks ~0 ~-112 ~0 ~14 ~-106 ~14 1033 1 1033 all run function tid:dungeon/sin/chambers/select_tier_room
...
execute unless score @s failed matches 1.. if predicate tid:random_04 positioned ~-6 ~-1 ~-3 if blocks ~ ~-128 ~ ~5 ~-110 ~18 1033 1 1033 all run function tid:dungeon/sin/chambers/select_alley
...
execute unless score @s failed matches 1.. if score sin_chambers_global value matches 3 if predicate tid:random_15 positioned ~-6 ~-1 ~-3 if blocks ~ ~-128 ~ ~5 ~-110 ~18 1033 1 1033 all run function tid:dungeon/sin/chambers/select_alley
