execute if predicate tid:random_57 at @s run tp @s ~66 ~ ~
execute if predicate tid:random_57 at @s run tp @s ~66 ~ ~
...
execute if predicate tid:random_50 at @s run tp @s ~2 ~ ~
execute if predicate tid:random_50 at @s run tp @s ~1 ~ ~
...
execute if predicate tid:random_57 at @s run tp @s ~ ~16 ~
execute if predicate tid:random_57 at @s run tp @s ~ ~16 ~
execute if predicate tid:random_50 at @s run tp @s ~ ~8 ~
execute if predicate tid:random_50 at @s run tp @s ~ ~4 ~
execute if predicate tid:random_50 at @s run tp @s ~ ~2 ~
