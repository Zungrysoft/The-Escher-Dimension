...
execute unless score @s failed matches 1.. if predicate tid:random_03 positioned ~-5 ~-1 ~1 if blocks ~ ~-128 ~ ~10 ~-120 ~10 1001 1 1001 all run function tid:dungeon/sin/select_room
