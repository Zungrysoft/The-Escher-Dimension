...
#White
execute unless score @s failed matches 1.. if predicate tid:random_09 if score @s counter1 matches 0 positioned ~-4 ~-6 ~1 if blocks ~ ~-128 ~ ~18 ~-114 ~6 1001 1 1001 all run function tid:dungeon/sin/select_church
