...
execute unless score @s failed matches 1.. if predicate tid:random_03 if score @s y matches 180..230 if score @s x matches -100..100 if score @s z matches -100..80 unless entity @e[type=area_effect_cloud,name="jungle_towerbase",distance=0..55] positioned ~-10 ~-4 ~1 if blocks ~ ~-128 ~ ~20 ~-111 ~20 1001 129 1001 all run function tid:dungeon/jungle/select_towerbase
