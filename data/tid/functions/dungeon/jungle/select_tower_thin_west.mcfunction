...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:jungle/tower_thin_west_1", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}

#Activate whichever structure block was picked
setblock ~ ~1 ~ minecraft:redstone_block

#Mark this area as generated
fill ~1 ~-128 ~1 ~5 ~-125 ~3 air
...
summon minecraft:area_effect_cloud ~3 ~1 ~2 {Duration:200,CustomName:"\"jungle_tower_room\""}
