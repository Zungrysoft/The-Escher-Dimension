...
#Check to see if this should become mossy
scoreboard players set temp value -50
...
execute if score temp value > calc value run function tid:dungeon/jungle/rng/mossy_cobblestone_replace
