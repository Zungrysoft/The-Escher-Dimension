...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:jungle/ladder_south_1", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
...
execute if predicate tid:random_90 positioned ~ ~11 ~1 run setblock ~ ~ ~ air
execute if predicate tid:random_90 positioned ~4 ~11 ~1 run setblock ~ ~ ~ air
