...
execute as @e[type=minecraft:area_effect_cloud,name="jungle_up",sort=random] at @s run function tid:dungeon/jungle/check_up
...
execute unless entity @e[type=area_effect_cloud,name="jungle_north"] unless entity @e[type=area_effect_cloud,name="jungle_south"] unless entity @e[type=area_effect_cloud,name="jungle_east"] unless entity @e[type=area_effect_cloud,name="jungle_west"] unless entity @e[type=area_effect_cloud,name="jungle_up"] unless entity @e[type=area_effect_cloud,name="jungle_junction_north"] unless entity @e[type=area_effect_cloud,name="jungle_junction_south"] unless entity @e[type=area_effect_cloud,name="jungle_junction_east"] unless entity @e[type=area_effect_cloud,name="jungle_junction_west"] run scoreboard players set jungle_handler_phase value 30