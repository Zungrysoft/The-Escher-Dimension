...
execute if entity @s[name="jungle_west"] unless score @s failed matches 1.. if predicate tid:random_10 positioned ~-5 ~-2 ~-2 if blocks ~ ~-128 ~ ~4 ~-122 ~4 1001 129 1001 all run function tid:dungeon/jungle/select_junction_west
execute if entity @s[name="jungle_junction_west"] unless score @s failed matches 1.. if predicate tid:random_10 positioned ~-5 ~-1 ~-2 if blocks ~ ~-128 ~ ~4 ~-122 ~4 1001 129 1001 all run function tid:dungeon/jungle/select_junction_west
...
execute unless score @s failed matches 1.. if predicate tid:random_03 if score @s y matches 180..230 unless entity @e[type=area_effect_cloud,name="jungle_towerbase",distance=0..55] positioned ~-21 ~-4 ~-10 if blocks ~ ~-128 ~ ~20 ~-111 ~20 1001 129 1001 all run function tid:dungeon/jungle/select_towerbase
