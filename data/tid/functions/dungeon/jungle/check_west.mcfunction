...
execute unless score @s failed matches 1.. if predicate tid:random_05 if score @s y matches 180..230 unless entity @e[type=area_effect_cloud,name="jungle_towerbase",distance=0..65] positioned ~-21 ~-4 ~-10 if blocks ~ ~-128 ~ ~20 ~-119 ~20 1001 129 1001 all run function tid:dungeon/jungle/select_towerbase