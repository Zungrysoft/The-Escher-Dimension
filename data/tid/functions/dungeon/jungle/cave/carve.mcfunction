...
#execute if score @s y matches 25..61 if score @s x matches -100..100 if score @s z matches -100..100 run scoreboard players set temp value 1

execute if score @s y matches 25..61 run scoreboard players set temp value 1
...
execute if predicate tid:random_03 run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:99999999,CustomName:"\"underwater_treasure\""}
