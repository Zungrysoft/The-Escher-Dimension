...
execute if score biome value matches 8 run function tid:dungeon/nature/biome/biome/crimson_tile
execute if score biome value matches 9 run function tid:dungeon/nature/biome/biome/diorite_tile
