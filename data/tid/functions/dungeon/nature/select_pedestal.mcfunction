...
execute if predicate tid:random_25 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/pedestal_2", posX: -1, posY: -2, posZ: -1, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
