...
#Add in doorways
summon minecraft:area_effect_cloud ~4 ~1 ~ {Duration:99999999,CustomName:"\"station_north\""}
summon minecraft:area_effect_cloud ~4 ~1 ~12 {Duration:99999999,CustomName:"\"station_south\""}
