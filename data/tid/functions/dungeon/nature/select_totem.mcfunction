...
#Special structures
execute if score nature_totems value matches ..3 if predicate tid:random_10 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/totem_s1", posX: -3, posY: -1, posZ: -3, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
execute if score nature_totems value matches ..3 if predicate tid:random_10 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/totem_s2", posX: -3, posY: -1, posZ: -3, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
execute if score nature_totems value matches ..3 if predicate tid:random_10 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/totem_s3", posX: -3, posY: -1, posZ: -3, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
execute if score nature_totems value matches ..3 if predicate tid:random_10 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/totem_s4", posX: -3, posY: -1, posZ: -3, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
