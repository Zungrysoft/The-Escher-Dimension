...
execute if score @s failed matches 1.. if predicate tid:random_25 positioned ~-13 ~-1 ~1 if blocks ~ ~128 ~ ~16 ~137 ~16 1001 1 1001 all run function tid:dungeon/nature/select_end
