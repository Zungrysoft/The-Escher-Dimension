...
execute if score temp value matches 5..7 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:nature/end_3", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
