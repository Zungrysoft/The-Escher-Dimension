...
execute unless score @s failed matches 1.. if predicate tid:random_03 positioned ~-11 ~-1 ~-5 if blocks ~ ~-128 ~ ~10 ~-118 ~10 1001 129 1001 all run function tid:dungeon/hellion/select_largeroom
