...
execute unless score @s failed matches 1.. if score @s x matches ..0 if predicate tid:random_10 positioned ~-7 ~-1 ~-3 if blocks ~ ~-128 ~ ~6 ~-123 ~6 1001 129 1001 all run function tid:dungeon/hellion/select_room
execute unless score @s failed matches 1.. if score @s z matches ..0 if predicate tid:random_10 positioned ~-7 ~-1 ~-3 if blocks ~ ~-128 ~ ~6 ~-123 ~6 1001 129 1001 all run function tid:dungeon/hellion/select_room
...
execute unless score @s failed matches 1.. if predicate tid:random_03 positioned ~1 ~-1 ~-1 if blocks ~ ~-128 ~ ~2 ~-122 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_stairwell
...
execute unless score @s failed matches 1.. if score @s x matches ..0 if score @s z matches 0.. if predicate tid:random_15 positioned ~-11 ~-1 ~-5 if blocks ~ ~-128 ~ ~10 ~-118 ~10 1001 129 1001 all run function tid:dungeon/hellion/select_largeroom

#Bridges only show up in the (+, ~) half
execute unless score @s failed matches 1.. if score @s x matches 0.. if predicate tid:random_15 positioned ~-10 ~-3 ~-1 if blocks ~ ~-128 ~ ~9 ~-123 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_bridge_west