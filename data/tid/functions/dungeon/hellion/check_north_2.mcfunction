...
execute unless score @s failed matches 1.. if score @s x matches 0.. if predicate tid:random_08 positioned ~-3 ~-1 ~-7 if blocks ~ ~-128 ~ ~6 ~-123 ~6 1001 129 1001 all run function tid:dungeon/hellion/select_room
execute unless score @s failed matches 1.. if score @s z matches 0.. if predicate tid:random_08 positioned ~-3 ~-1 ~-7 if blocks ~ ~-128 ~ ~6 ~-123 ~6 1001 129 1001 all run function tid:dungeon/hellion/select_room
...
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~-4 ~-2 ~-9 if blocks ~ ~-128 ~ ~8 ~-112 ~8 1001 129 1001 all run function tid:dungeon/hellion/select_totem
execute unless score @s failed matches 1.. if predicate tid:random_06 positioned ~-1 ~-3 ~-10 if blocks ~ ~-128 ~ ~2 ~-123 ~9 1001 129 1001 all run function tid:dungeon/hellion/select_bridge_north
