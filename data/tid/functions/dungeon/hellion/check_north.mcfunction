...
execute unless score @s failed matches 1.. if predicate tid:random_05 positioned ~-1 ~-1 ~-6 if blocks ~ ~-128 ~ ~2 ~-123 ~5 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_north
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~-1 ~-4 ~-6 if blocks ~ ~-128 ~ ~2 ~-123 ~5 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_south
