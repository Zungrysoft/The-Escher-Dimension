...
execute unless score @s failed matches 1.. if score hellion_global value matches 0 if predicate tid:random_20 positioned ~-5 ~-1 ~-11 if blocks ~ ~-128 ~ ~10 ~-118 ~10 1001 129 1001 all run function tid:dungeon/hellion/select_largeroom
