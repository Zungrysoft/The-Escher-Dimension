...
execute unless score @s failed matches 1.. if predicate tid:random_10 positioned ~1 ~-1 ~-3 if blocks ~ ~-127 ~ ~6 ~-123 ~6 1001 129 1001 all run function tid:dungeon/hellion/select_room
execute unless score @s failed matches 1.. if predicate tid:random_05 positioned ~1 ~-1 ~-1 if blocks ~ ~-127 ~ ~5 ~-123 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_east
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~1 ~-4 ~-1 if blocks ~ ~-127 ~ ~5 ~-123 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_west
...
execute unless score @s failed matches 1.. if predicate tid:random_005 positioned ~1 ~-1 ~-4 if blocks ~ ~-128 ~ ~8 ~-113 ~8 1001 129 1001 all run function tid:dungeon/hellion/select_totem
