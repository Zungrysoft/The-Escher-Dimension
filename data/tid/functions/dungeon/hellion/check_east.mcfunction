...
execute unless score @s failed matches 1.. if predicate tid:random_05 positioned ~1 ~-1 ~-1 if blocks ~ ~-128 ~ ~5 ~-123 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_east
execute unless score @s failed matches 1.. if predicate tid:random_01 positioned ~1 ~-4 ~-1 if blocks ~ ~-128 ~ ~5 ~-123 ~2 1001 129 1001 all run function tid:dungeon/hellion/select_stairs_west
