...
execute unless score @s failed matches 1.. if predicate tid:random_02 positioned ~1 ~-2 ~-4 if blocks ~ ~128 ~ ~4 ~136 ~8 1001 1 1033 all run function tid:dungeon/moon/select_connector_east
