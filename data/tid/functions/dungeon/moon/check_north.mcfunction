...
execute unless score @s failed matches 1.. if predicate tid:random_02 positioned ~-4 ~-2 ~-5 if blocks ~ ~128 ~ ~8 ~136 ~4 1001 1 1033 all run function tid:dungeon/moon/select_connector_north
