...
execute if score @s failed matches 1.. if block ~-3 ~-2 ~ air positioned ~-5 ~-2 ~-4 if blocks ~ ~128 ~ ~4 ~136 ~8 1001 1 1033 all run function tid:dungeon/moon/select_connector_west
