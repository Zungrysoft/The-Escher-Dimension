...
setblock ~ ~ ~ minecraft:structure_block{name: "tid:moon/stairs_south", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}

#Activate whichever structure block was picked
setblock ~ ~1 ~ minecraft:redstone_block

#Open the wall if necessary
execute if entity @s[name="moon_south"] run fill ~1 ~1 ~ ~3 ~3 ~ air
