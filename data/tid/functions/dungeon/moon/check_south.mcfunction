...
execute if score @s failed matches 1.. if block ~ ~-2 ~3 air positioned ~-4 ~-2 ~1 if blocks ~ ~128 ~ ~8 ~136 ~4 1001 1 1033 all run function tid:dungeon/moon/select_connector_south
