...
execute unless score @s failed matches 1.. if predicate tid:random_06 positioned ~1 ~-4 ~-3 unless entity @e[type=area_effect_cloud,name="moon_tower_marker",distance=0..10] if blocks ~ ~128 ~ ~7 ~136 ~7 1001 1 1033 all run function tid:dungeon/moon/select_towerbase
