...
execute if score temp value matches 0.. run function tid:dungeon/moon/pillar/run_count
...
execute at @e[type=area_effect_cloud,tag=new,limit=1] run function tid:dungeon/moon/pillar/medium
