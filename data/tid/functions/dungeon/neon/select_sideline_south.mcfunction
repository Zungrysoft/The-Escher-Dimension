...
execute if score temp value matches 1 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:neon/sideline_1", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
...
execute if score temp value matches 0 run setblock ~ ~ ~ minecraft:structure_block{name: "tid:neon/sideline_16", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
