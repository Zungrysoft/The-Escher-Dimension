...
#Ports
execute if score @s failed matches 1.. if score neon_ports value matches 1.. positioned ~-5 ~13 ~-3 if blocks ~-15 ~128 ~ ~2 ~134 ~7 1001 1 1001 all if blocks ~3 ~128 ~ ~3 ~134 ~7 1001 1 1033 all run function tid:dungeon/neon/select_port_west
