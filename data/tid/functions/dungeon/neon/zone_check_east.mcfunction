...
#Ports
execute if score @s failed matches 1.. if score neon_ports value matches 1.. positioned ~2 ~13 ~-3 if blocks ~1 ~128 ~ ~18 ~134 ~7 1001 1 1001 all if blocks ~ ~128 ~ ~ ~134 ~7 1001 1 1033 all run function tid:dungeon/neon/select_port_east
