...
execute if score @s tries matches 10.. if score neon_rooms value matches ..25 run scoreboard players set @s failed 1
...
execute if score @s z matches 115.. run scoreboard players set @s failed 1
