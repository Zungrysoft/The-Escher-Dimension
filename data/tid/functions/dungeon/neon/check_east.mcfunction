...
execute unless score @s failed matches 1.. if predicate tid:random_07 positioned ~1 ~-3 ~-4 if blocks ~ ~-3 ~ ~9 ~9 ~9 1033 1 1001 all run function tid:dungeon/neon/select_cross
