...
execute if predicate tid:random_20 run setblock ~ ~ ~ brewing_stand

#Decide whether to generate a blast furnace
execute if predicate tid:random_10 if block ~-1 ~ ~ crimson_planks run setblock ~ ~ ~ blast_furnace[facing=east]
execute if predicate tid:random_10 if block ~1 ~ ~ crimson_planks run setblock ~ ~ ~ blast_furnace[facing=west]
execute if predicate tid:random_10 if block ~ ~ ~-1 crimson_planks run setblock ~ ~ ~ blast_furnace[facing=south]
execute if predicate tid:random_10 if block ~ ~ ~1 crimson_planks run setblock ~ ~ ~ blast_furnace[facing=north]
...
execute if predicate tid:random_10 if block ~-1 ~ ~ crimson_planks run setblock ~ ~ ~ smoker[facing=east]
execute if predicate tid:random_10 if block ~1 ~ ~ crimson_planks run setblock ~ ~ ~ smoker[facing=west]
execute if predicate tid:random_10 if block ~ ~ ~-1 crimson_planks run setblock ~ ~ ~ smoker[facing=south]
execute if predicate tid:random_10 if block ~ ~ ~1 crimson_planks run setblock ~ ~ ~ smoker[facing=north]
