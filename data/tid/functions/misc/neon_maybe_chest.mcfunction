...
execute if predicate tid:random_40 if block ~-1 ~ ~ dark_prismarine run setblock ~ ~ ~ chest[facing=east]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~1 ~ ~ dark_prismarine run setblock ~ ~ ~ chest[facing=west]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~-1 dark_prismarine run setblock ~ ~ ~ chest[facing=south]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~1 dark_prismarine run setblock ~ ~ ~ chest[facing=north]{LootTable: "tid:chests/neon"}

execute if predicate tid:random_40 if block ~-1 ~ ~ purpur_pillar run setblock ~ ~ ~ chest[facing=east]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~1 ~ ~ purpur_pillar run setblock ~ ~ ~ chest[facing=west]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~-1 purpur_pillar run setblock ~ ~ ~ chest[facing=south]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~1 purpur_pillar run setblock ~ ~ ~ chest[facing=north]{LootTable: "tid:chests/neon"}

execute if predicate tid:random_40 if block ~-1 ~ ~ purpur_block run setblock ~ ~ ~ chest[facing=east]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~1 ~ ~ purpur_block run setblock ~ ~ ~ chest[facing=west]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~-1 purpur_block run setblock ~ ~ ~ chest[facing=south]{LootTable: "tid:chests/neon"}
execute if predicate tid:random_40 if block ~ ~ ~1 purpur_block run setblock ~ ~ ~ chest[facing=north]{LootTable: "tid:chests/neon"}