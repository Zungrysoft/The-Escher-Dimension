...
#Automaton
execute if predicate tid:random_20 run setblock ~ ~ ~ spawner{MaxNearbyEntities: 3s, RequiredPlayerRange: 16s, SpawnCount: 15s, MinSpawnDelay: 200s, MaxSpawnDelay: 800s, Delay: 20s, SpawnRange: 5s, SpawnPotentials: [{Entity: {id: "minecraft:armor_stand",Invisible:1,Tags:["spawncloud","auto"]}, Weight: 1}]}
#Magma Cube
