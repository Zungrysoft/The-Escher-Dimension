...
#Place the ores
execute if predicate tid:random_70 positioned ~1 ~ ~1 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~2 ~ ~1 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~3 ~ ~1 run function tid:misc/gravel_pile_ore

execute if predicate tid:random_70 positioned ~1 ~ ~2 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~2 ~ ~2 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~3 ~ ~2 run function tid:misc/gravel_pile_ore

execute if predicate tid:random_70 positioned ~1 ~ ~3 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~2 ~ ~3 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~3 ~ ~3 run function tid:misc/gravel_pile_ore

execute if predicate tid:random_70 positioned ~1 ~ ~4 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~2 ~ ~4 run function tid:misc/gravel_pile_ore
execute if predicate tid:random_70 positioned ~3 ~ ~4 run function tid:misc/gravel_pile_ore
