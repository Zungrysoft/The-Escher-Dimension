...
#Poison (Rare)
execute if predicate tid:random_03 run setblock ~ ~ ~ spawner{MaxNearbyEntities: 100s, RequiredPlayerRange: 10s, SpawnCount: 1s, MinSpawnDelay: 3s, MaxSpawnDelay: 3s, Delay: 1s, SpawnRange: 0s, SpawnPotentials: [{Entity: {id: "minecraft:potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:poison"}}}, Weight: 1}]}
#Slowness (Rare)
...
#Healing (Rare)
execute if predicate tid:random_02 run setblock ~ ~ ~ spawner{MaxNearbyEntities: 100s, RequiredPlayerRange: 10s, SpawnCount: 1s, MinSpawnDelay: 3s, MaxSpawnDelay: 3s, Delay: 1s, SpawnRange: 0s, SpawnPotentials: [{Entity: {id: "minecraft:potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:healing"}}}, Weight: 1}]}
