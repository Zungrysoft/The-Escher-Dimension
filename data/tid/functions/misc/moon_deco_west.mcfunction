...
#Flower pedestal
execute if score temp value matches 0..1 run setblock ~ ~ ~ end_stone_brick_stairs[facing=west,half=top]
...
#Chest
execute if score temp value matches 6..7 run setblock ~ ~ ~ chest[facing=west]{LootTable: "tid:chests/moon"}
