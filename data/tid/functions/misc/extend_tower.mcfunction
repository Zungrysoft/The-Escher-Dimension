...
execute if predicate tid:random_25 if blocks ~ ~-123 ~ ~4 ~-116 ~4 1 129 1 all run setblock ~ ~2 ~ structure_block{name: "tid:sin/deco_medium_3_extension", posX: 0, posY: 0, posZ: 0, ignoreEntities: 0b, powered: 0b, mode: "LOAD", showair: 0b, showboundingbox: 0b}
