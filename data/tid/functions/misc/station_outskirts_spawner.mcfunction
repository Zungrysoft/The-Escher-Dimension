...
# Flesheater
execute if predicate tid:random_50 run setblock ~ ~ ~ spawner{MaxNearbyEntities: 2s, RequiredPlayerRange: 16s, SpawnCount: 200s, MinSpawnDelay: 300s, MaxSpawnDelay: 400s, Delay: 1s, SpawnRange: 3s, SpawnPotentials: [{Entity: {id:"minecraft:skeleton",CustomName:'[{"text":"Flesheater"}]',Health:14,Attributes:[{Name:"generic.max_health",Base:14F},{Name:"generic.movement_speed",Base:0.2f},{Name:"generic.attack_damage",Base:5f},{Name:"generic.armor",Base:-2000f}],Tags:["jumping_skeleton"],HandItems:[{id:"minecraft:iron_axe",Count:1},{id:"minecraft:iron_axe",Count:1}],ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:612727}},Count:1},{id:"minecraft:leather_leggings",tag:{display:{color:612727}},Count:1},{id:"minecraft:leather_chestplate",tag:{display:{color:612727}},Count:1},{id:"minecraft:nether_quartz_ore",Count:1}],HandDropChances:[0F,0F],ArmorDropChances:[0F,0F,0F,0F],DeathLootTable:""},Weight:1}]}
