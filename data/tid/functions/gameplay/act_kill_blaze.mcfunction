...
execute if entity @s[nbt={Inventory:[{Slot:-106b, tag:{act_offhand_kill_blaze:1b}}]}] if score @s kill_blaze matches 1.. run function tid:gameplay/effect_grant_offhand
