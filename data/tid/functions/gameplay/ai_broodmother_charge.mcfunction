...
execute as @p at @s run function tid:gameplay/ai_broodmother_target_run

#Store the coords of the monster
...
#Scale the delta vector by the monster's jump speed
...
#Store this data into the monster
