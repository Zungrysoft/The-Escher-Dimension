...
execute if entity @s[nbt={SelectedItem:{tag:{summoning_staff:1b}}}] if score @s carrot_stick_use matches 1.. if score temp value matches 10.. run function tid:gameplay/summoning_staff_use