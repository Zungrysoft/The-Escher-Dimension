...
execute if score temp3 value matches 1 run function tid:gameplay/tome_summoning_activate_summon
execute if score temp3 value matches 2 positioned ~ ~-2 ~ run function tid:gameplay/tome_summoning_activate_summon