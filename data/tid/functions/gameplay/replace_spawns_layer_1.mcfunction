...
#Boomstick Basement
execute if predicate tid:random_30 if block ~ ~-1 ~ bricks run summon minecraft:zombie ~ ~ ~ {HandItems:[{id:magenta_dye,Count:1}],HandDropChances:[2F]}

#The Deep Cold
#Dye Zombie
execute if predicate tid:random_30 if block ~ ~-1 ~ packed_ice run summon minecraft:zombie ~ ~ ~ {HandItems:[{id:light_blue_dye,Count:1}],HandDropChances:[2F]}
execute if predicate tid:random_30 if block ~ ~-1 ~ blue_ice run summon minecraft:zombie ~ ~ ~ {HandItems:[{id:light_blue_dye,Count:1}],HandDropChances:[2F]}
#Backup Cats
