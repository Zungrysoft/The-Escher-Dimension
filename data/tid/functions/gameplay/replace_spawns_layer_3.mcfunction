...
execute if block ~ ~-1 ~ grass_block run summon minecraft:zombie ~ ~ ~ {HandItems:[{id:blue_dye,Count:1}],HandDropChances:[1.00F]}
execute if block ~ ~-1 ~ warped_wart_block run summon minecraft:zombie ~ ~ ~ {HandItems:[{id:blue_dye,Count:1}],HandDropChances:[1.00F]}
