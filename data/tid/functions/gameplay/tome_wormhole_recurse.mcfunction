#Particle trail
execute if score temp value matches ..75 run particle minecraft:dust 0 0.2 0.2 2
...
execute if score temp2 value matches 0 positioned ^ ^ ^-1 run function tid:gameplay/tome_wormhole_activate
...
execute if score temp2 value matches 1 positioned ^ ^ ^.5 run function tid:gameplay/tome_wormhole_recurse
