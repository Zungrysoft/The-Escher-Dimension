...
#Babirusan Shiv
execute if entity @s[nbt={SelectedItem:{id:"minecraft:flint",tag:{super_flint:1b}}}] unless data entity @s Inventory[{id:"minecraft:gold_ingot"}] run scoreboard players set cancel value 1
