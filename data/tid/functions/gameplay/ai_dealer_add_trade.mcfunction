...
#Book of Taliesyn
execute if score temp value matches 9 run data modify entity @s Offers.Recipes append value {maxUses:9999999,specialPrice:0,buy:{id:emerald,Count:28},sell:{id:book,Count:1,tag:{legendary:1b,display:{Name:'[{"text":"Book of Taliesyn","italic":false,"bold":true,"color":"dark_aqua"}]',Lore:['[{"text":"Destroys nearby arrows when held","italic":false,"color":"green"}]']},Recipes:[],Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:1,book_barrier_2:1b}}}
