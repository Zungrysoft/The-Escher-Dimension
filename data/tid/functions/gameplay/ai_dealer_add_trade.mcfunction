...
#Add the trade
#Ascent Falchion
execute if score temp value matches 0 run data modify entity @s Offers.Recipes append value {maxUses:9999999,specialPrice:0,buy:{id:emerald,Count:15},sell:{id:diamond_sword,Count:1,tag:{display:{Name:'[{"text":"Ascent Falchion","italic":false,"bold":true,"color":"dark_aqua"}]',Lore:['[{"text":"Inflicts levitation on a","italic":false,"color":"aqua"}]','[{"text":"random monster on kill","italic":false,"color":"aqua"}]']},Unbreakable:1,act_melee_kill_mob:1b,eff_inflict_levitation_random:1b}}}
...
#Jack of Spades
execute if score temp value matches 10 run data modify entity @s Offers.Recipes append value {maxUses:9999999,specialPrice:0,buy:{id:emerald,Count:20},sell:{id:iron_shovel,Count:1,tag:{display:{Name:'[{"text":"Jack of Spades","italic":false,"bold":true,"color":"yellow"}]'},Enchantments:[{id:knockback,lvl:5}]}}}

#Jack of Spades
execute if score temp value matches 11 run data modify entity @s Offers.Recipes append value {maxUses:9999999,specialPrice:0,buy:{id:emerald,Count:20},sell:{id:iron_shovel,Count:1,tag:{display:{Name:'[{"text":"Jack of Spades","italic":false,"bold":true,"color":"yellow"}]'},Enchantments:[{id:knockback,lvl:5}]}}}
