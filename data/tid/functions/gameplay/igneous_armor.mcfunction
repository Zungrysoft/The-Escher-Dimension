...
attribute @s minecraft:generic.attack_damage modifier remove 21483d2f-4e05-4f9a-9e04-8ca571aac87f
...
execute if score bonus value matches 1 run attribute @s minecraft:generic.attack_damage modifier add 21483d2f-4e05-4f9a-9e04-8ca571aac87f igneous 3 add
