...
#Tank
execute if score @s counter1 matches 24..25 run summon minecraft:piglin_brute ~ ~ ~ {IsImmuneToZombification:1,HandItems:[{id:golden_axe,Count:1},{id:shield,tag:{BlockEntityTag:{Base:7,Patterns:[{Pattern:ld,Color:12}]}},Count:1}],ArmorItems:[{id:leather_boots,tag:{display:{color:4673362}},Count:1},{id:leather_leggings,tag:{display:{color:4673362}},Count:1},{id:leather_chestplate,tag:{display:{color:4673362}},Count:1},{id:leather_helmet,tag:{display:{color:4673362}},Count:1}],HandDropChances:[0F,0.2F],ArmorDropChances:[0F,0F,0F,0F],CannotHunt:1,Tags:["keep"]}
