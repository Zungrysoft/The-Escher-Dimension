...
function tid:gameplay/act_mine_spawner
function tid:gameplay/act_deal_damage
function tid:gameplay/act_kill_mob
function tid:gameplay/tome_barrier

#Tome mainhand checks
function tid:gameplay/tome_oxidation_melee
function tid:gameplay/tome_summoning_melee
function tid:gameplay/tome_block_melee
function tid:gameplay/tome_ember_melee
function tid:gameplay/tome_fireball_melee

#Tome offhand checks
function tid:gameplay/tome_oxidation_offhand
function tid:gameplay/tome_summoning_offhand
function tid:gameplay/tome_block_offhand
function tid:gameplay/tome_ember_offhand
function tid:gameplay/tome_fireball_offhand
