...
execute if score temp2 value matches 0 positioned ^ ^ ^-1 run function tid:gameplay/staff_oxidation_activate
...
execute if score temp2 value matches 1 positioned ^ ^ ^.5 run function tid:gameplay/staff_oxidation_recurse