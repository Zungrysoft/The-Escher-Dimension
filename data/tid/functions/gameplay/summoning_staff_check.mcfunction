...
execute if score temp3 value matches 1 run function tid:gameplay/summoning_staff_summon
execute if score temp3 value matches 2 positioned ~ ~-2 ~ run function tid:gameplay/summoning_staff_summon