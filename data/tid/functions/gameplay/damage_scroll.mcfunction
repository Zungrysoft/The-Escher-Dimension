...
execute store result score temp value run clear @s minecraft:mojang_banner_pattern{damage_scroll:1b} 0
...
execute unless score @s damage_boost = temp value run function tid:gameplay/damage_scroll_effect
