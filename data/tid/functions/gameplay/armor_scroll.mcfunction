...
execute store result score temp value run clear @s minecraft:mojang_banner_pattern{armor_scroll:1b} 0
...
execute unless score @s armor_boost = temp value run function tid:gameplay/armor_scroll_effect
