...
execute if score @s counter1 matches 60 playsound minecraft:block.beacon.activate block @a ~1.5 ~-1 ~1.5

#If fully open, it can teleport players
data modify storage tid temp set from entity @s Color
