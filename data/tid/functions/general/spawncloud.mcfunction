...
execute if entity @s[tag=war_pig_1] run function tid:custom_mobs/war_pig_1
execute if entity @s[tag=war_pig_2] run function tid:custom_mobs/war_pig_2
execute if entity @s[tag=war_pig_3] run function tid:custom_mobs/war_pig_3
execute if entity @s[tag=war_pig_4] run function tid:custom_mobs/war_pig_4
execute if entity @s[tag=vex] run summon vex ~ ~ ~ {Health:4,Tags:["keep"]}
