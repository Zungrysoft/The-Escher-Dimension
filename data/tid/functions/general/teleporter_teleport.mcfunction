...
execute if score temp value matches 6 in tid:layer_jungle positioned 0 55 0 run function tid:general/teleporter_teleport_run
...
#Teleporter to and from Sin City
execute if score temp value matches 8 in tid:layer_sin positioned 0 55 0 run function tid:general/teleporter_teleport_run
